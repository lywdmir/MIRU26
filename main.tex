...
VAE や GAN の潜在空間はデータ多様体をパラメータ化しており，潜在空間上の線形操作による意味属性の編集が広く行われてきた~\cite{Goetschalckx2019,Harkonen2020,Shen2020}．
しかし，実世界のデータ分布には偏りがあるため，非線形な変動が存在する~\cite{Jahanian2020,Aoshima2023}．
この非線形性を体系的に扱う枠組みとして，潜在空間へのリーマン計量の導入がある~\cite{Gruffaz2025}．
計量の構成法は大きく二つに分かれ，追加ネットワークで計量を学習する手法~\cite{Yang2018,Arvanitidis2022}と，事前学習済みデコーダを通じた引き戻し計量を用いる学習不要な手法~\cite{Shao2017,Chen2018,Arvanitidis2018,Arvanitidis2021}が存在する．
前者は元の多様体構造を上書きする恐れがあるのに対し，後者はモデルが学習した幾何を直接利用する．
本研究はこの後者のアプローチを，ノイズ空間が低次元でない拡散モデルへ拡張する．
...
%     \newlength{\interpw}
%     \setlength{\interpw}{8.1cm}
%     \begin{tabular}{rc}
%         \rotatebox{90}{\textcolor{BLUE}{LERP}}      & {\includegraphics[width=\interpw]{assets/interpolation/image/5/vangogh_lerp.jpg}}      \\ \addlinespace[1.5pt]
%         \rotatebox{90}{\textcolor{GREEN}{SLERP}}    & {\includegraphics[width=\interpw]{assets/interpolation/image/5/vangogh_slerp.jpg}}     \\ \addlinespace[1.5pt]
%         \rotatebox{90}{\textcolor{PURPLE}{NAO}}     & {\includegraphics[width=\interpw]{assets/interpolation/image/5/vangogh_nao.jpg}}       \\ \addlinespace[1.5pt]
%         \rotatebox{90}{\textcolor{PINK}{NoiseDiff}} & {\includegraphics[width=\interpw]{assets/interpolation/image/5/vangogh_noisediff.jpg}} \\ \addlinespace[1.5pt]
%         \rotatebox{90}{\textcolor{ORANGE}{GeoDiff}} & {\includegraphics[width=\interpw]{assets/interpolation/image/5/vangogh_geodiff.jpg}}   \\ \addlinespace[1.5pt]
%         \rotatebox{90}{\textcolor{GRAY}{FIM-based}} & {\includegraphics[width=\interpw]{assets/interpolation/image/5/vangogh_fim.jpg}}       \\ \addlinespace[1.5pt]
%         \rotatebox{90}{\textcolor{BLACK}{Ours}}     & {\includegraphics[width=\interpw]{assets/interpolation/image/5/vangogh_ours.jpg}}      \\ \addlinespace[1.5pt]
%                                                       & \includegraphics[scale=0.7]{assets/interpolation/imagelabel.drawio-crop.pdf}                  \\ \addlinespace[1.5pt]
...
%     \begin{tabular}{rc}
%         \raisebox{2.9mm}{\textcolor{BLUE}{LERP}}      & {\includegraphics[width=\interpw]{assets/interpolation/image/11/vangogh_lerp.jpg}}      \\ \addlinespace[1.5pt]
%         \raisebox{2.9mm}{\textcolor{GREEN}{SLERP}}    & {\includegraphics[width=\interpw]{assets/interpolation/image/11/vangogh_slerp.jpg}}     \\ \addlinespace[1.5pt]
%         \raisebox{2.9mm}{\textcolor{PURPLE}{NAO}}     & {\includegraphics[width=\interpw]{assets/interpolation/image/11/vangogh_nao.jpg}}       \\ \addlinespace[1.5pt]
%         \raisebox{2.9mm}{\textcolor{PINK}{NoiseDiff}} & {\includegraphics[width=\interpw]{assets/interpolation/image/11/vangogh_noisediff.jpg}} \\ \addlinespace[1.5pt]
%         \raisebox{2.9mm}{\textcolor{ORANGE}{GeoDiff}} & {\includegraphics[width=\interpw]{assets/interpolation/image/11/vangogh_geodiff.jpg}}   \\ \addlinespace[1.5pt]
%         \raisebox{2.9mm}{\textcolor{GRAY}{FIM-based}} & {\includegraphics[width=\interpw]{assets/interpolation/image/11/vangogh_fim.jpg}}       \\ \addlinespace[1.5pt]
%         \raisebox{2.9mm}{\textcolor{BLACK}{Ours}}     & {\includegraphics[width=\interpw]{assets/interpolation/image/11/vangogh_ours.jpg}}      \\ \addlinespace[1.5pt]
